...
- Aside of the regular attendance list, prepare a list with the following data: Platz-number, Gender (F/M), smoking (yes/no), pets (yes/no). We will visualize if this confounder data has a relationship with the microbiome data.
